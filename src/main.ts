...
import { initAddServers } from "./features/add-servers";
...
// views/add-servers-sheet.ts asks this module for logging and the two forms of measuring a
// server just added.
initAddServersSheet({
  log,
  autoCheck: (servers) => autoCheck(servers),
  checkServers: (servers) => void checkServers(servers),
});
