...
const ICONS: Record<string, Icon> = {
  ...
  "shield-off": {
    paths: ["M12 3 19.5 6v6c0 4.4-3.2 7.8-7.5 9-4.3-1.2-7.5-4.6-7.5-9V6Z", "M4.5 4.5l15 15"],
  },
  "shield-alert": {
  ...
  heart: { paths: ["M12 19.5s-7.5-4.6-7.5-10.2A4.1 4.1 0 0 1 12 7a4.1 4.1 0 0 1 7.5 2.3c0 5.6-7.5 10.2-7.5 10.2Z"] },
  coffee: { paths: ["M4.5 9.5h11v4.5a5 5 0 0 1-5 5h-1a5 5 0 0 1-5-5Z", "M15.5 11h1.25a2.5 2.5 0 0 1 0 5H15", "M8 3.5v2.5M11.5 3.5v2.5"] },
  scan: {
    paths: [
